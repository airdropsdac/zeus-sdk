...
void dappservhodl::activate( const symbol& symbol, time_point_sec start, time_point_sec end) {
...
void dappservhodl::grab( name owner, const symbol& symbol, name ram_payer )
{
...
void dappservhodl::withdraw( name owner, const symbol& symbol ) {   
   require_auth(owner);
...
void dappservhodl::stake( name owner, name provider, name service, asset quantity) {
   require_auth(owner);
...
void dappservhodl::unstake( name owner, name provider, name service, asset quantity) {
   require_auth(owner);
...
void dappservhodl::add_balance( name owner, asset value, name ram_payer )
{
